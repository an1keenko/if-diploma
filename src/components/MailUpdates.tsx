    ...
    <Container>
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          ...
          />
          <IconButton type="submit" sx={{ p: '10px' }} aria-label="join">
            <Typography color="#000F08">JOIN</Typography>
          </IconButton>
        </Box>
      </form>
      {message && <Typography sx={{ textAlign: 'center', mt: '16px' }}>{message}</Typography>}
    </Container>
  )
  // TODO fix to refresh pagge when submitting
}
